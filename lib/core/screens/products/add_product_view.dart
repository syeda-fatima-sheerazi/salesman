          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() {
                ...
                final imageErr = controller.imageErrorMessage.value;
                final hasImageErr = imageErr.isNotEmpty;
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: Ink(
                          ...
                          decoration: BoxDecoration(
                            color: path == null ? cs.surfaceContainerLow : null,
                            borderRadius: BorderRadius.circular(12.r),
                            border: Border.all(
                              color: hasImageErr ? cs.error : cs.outlineVariant,
              ...
              SizedBox(height: 12.h),
              Obx(() {
                final n = controller.variantRowCount.value;
                final variantErr = controller.variantErrorMessage.value;
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    for (int i = 0; i < n; i++) ...[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (n > AddProductController.initialVariantRows)
                          TextButton.icon(
